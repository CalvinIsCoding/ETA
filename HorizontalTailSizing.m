...
% Df            (1,1)              Largest aft fuselage diameter (50 in)
...
% CLaw          (1,1)              Coefficient of lift slope vs alpha for
%                                  the wing
...
% OUTPUT:
%
% Sh            (1,1)              Planform area of horizontal tail
...
Cma = CLaw*(h-.25)-CLah*.98*Sh/S*(lopt/MACh-h)*(1-depida); % Eqn 6.67
